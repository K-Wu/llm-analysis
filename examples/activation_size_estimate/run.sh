...
python -m llm_analysis.analysis train --model_name llm_analysis/model_configs/activation_size_estimate-bert_1.json --gpu_name a100-pcie-80gb --total_num_tokens 300e9  --activation_recomputation 0 --activation_reloading 1 --tp_size 2 --pp_size 1  --global_batch_size 16 --total_num_gpus 2 --achieved_tflops 153 --output_dir ${output_dir}

python -m llm_analysis.analysis train --model_name llm_analysis/model_configs/activation_size_estimate-bert_2.json --gpu_name a100-pcie-80gb --total_num_tokens 300e9  --activation_recomputation 0 --activation_reloading 1 --tp_size 2 --pp_size 1  --global_batch_size 16 --total_num_gpus 2 --achieved_tflops 153 --output_dir ${output_dir}

python -m llm_analysis.analysis train --model_name llm_analysis/model_configs/activation_size_estimate-bert_3.json --gpu_name a100-pcie-80gb --total_num_tokens 300e9  --activation_recomputation 0 --activation_reloading 1 --tp_size 2 --pp_size 1  --global_batch_size 16 --total_num_gpus 2 --achieved_tflops 153 --output_dir ${output_dir}
