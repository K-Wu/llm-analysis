...
python -m llm_analysis.analysis train --model_name decapoda-research_llama-7b-hf --gpu_name ${gpu_name} --total_num_tokens 1e12 --activation_recomputation 0 --activation_reloading 1 --tp_size 8 --pp_size 8 --sp_size 8 --global_batch_size ${global_batch_size} --total_num_gpus 2048 --flops_efficiency ${flops_efficiency} --hbm_memory_efficiency ${hbm_memory_efficiency} --output_dir ${output_dir}

python -m llm_analysis.analysis train --model_name decapoda-research_llama-13b-hf --gpu_name ${gpu_name} --total_num_tokens 1e12 --activation_recomputation 0 --activation_reloading 1 --tp_size 8 --pp_size 8 --sp_size 8 --global_batch_size ${global_batch_size} --total_num_gpus 2048 --flops_efficiency ${flops_efficiency} --hbm_memory_efficiency ${hbm_memory_efficiency} --output_dir ${output_dir}

python -m llm_analysis.analysis train --model_name decapoda-research_llama-30b-hf --gpu_name ${gpu_name} --total_num_tokens 1.4e12 --activation_recomputation 0 --activation_reloading 1 --tp_size 8 --pp_size 8 --sp_size 8 --global_batch_size ${global_batch_size} --total_num_gpus 2048 --flops_efficiency ${flops_efficiency} --hbm_memory_efficiency ${hbm_memory_efficiency} --output_dir ${output_dir}
